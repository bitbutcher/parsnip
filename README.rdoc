...
creating RESTful apis.  Particularly those tired of ActiveSupport::ParamsParser 
...
applications (verifies with Rails 3.2.x). 
Simply add <tt>gem 'parsnip'<tt> to your Gemfile
